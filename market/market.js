...
async function loadMarketData() {
    ...
    try {
        ...
        if (!tableResult.Data || !Array.isArray(tableResult.Data)) throw new Error("Data tidak valid");
        ...
        container.innerHTML = `<div style="color:#e53935;text-align:center;padding:2rem;">Gagal memuat data.<br>${err.message}</div>`;
